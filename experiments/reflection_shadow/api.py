...
app = FastAPI(
    title="Reflection of Light and Shadow Formation",
    version="1.0.0",
    description="Virtual optics lab for reflection of light and shadow formation"
)
...
def predict(request: PredictRequest):
    """
    Predict reflection & shadow behavior using trained ML model.
    """
