...
app = FastAPI(
    title="Types of Motion: Linear, Circular and Periodic",
    version="1.0.0",
    description="Virtual physics lab for simulating linear, circular, and periodic motion",
)
...
def predict(request: PredictRequest):
    """
    Predict motion using trained ML model.
    """
