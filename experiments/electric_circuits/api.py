...
app = FastAPI(
    title="Electric Circuits and Conductors",
    version="1.0.0",
    description="Virtual lab backend for simulating electric circuits and conductors",
)
...
def predict(request: PredictRequest):
    """
    Predict circuit behavior using trained ML model.
    """
