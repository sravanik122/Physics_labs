...
app = FastAPI(
    title="Force, Pressure and Area Relationship",
    version="1.0.0",
    description="Virtual physics lab for understanding force, pressure, and area relationship"
)
...
def simulate(inputs: ExperimentInputs):
    """
    Run deterministic force–pressure–area simulation.
    """
